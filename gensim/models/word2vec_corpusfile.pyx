                    ...
                    for j in range(j, k):
                        ...
                        if c.hs:
                            w2v_fast_sentence_sg_hs(
                                ...
                                c.alpha, c.work, c.word_locks, c.compute_loss, &c.running_training_loss, c.learn_hidden, c.learn_vectors)
                        if c.negative:
                            c.next_random = w2v_fast_sentence_sg_neg(
                                ...
                                c.compute_loss, &c.running_training_loss, c.learn_hidden, c.learn_vectors)
                ...
                for i in range(idx_start, idx_end):
                    ...
                    if c.hs:
                        w2v_fast_sentence_cbow_hs(
                            ...
                            c.work, i, j, k, c.cbow_mean, c.word_locks, c.compute_loss, &c.running_training_loss, c.learn_hidden, c.learn_vectors)
                    ...
                    if c.negative:
                        c.next_random = w2v_fast_sentence_cbow_neg(
                            ...
                            c.next_random, c.word_locks, c.compute_loss, &c.running_training_loss, c.learn_hidden, c.learn_vectors)
